...
const Products = () => {
    ...
    const [price, setPrice] = useState([0, 23001]);
    ...
    return (
        ...
        {loading ? <Loader />: (
            <Fragment>
            <MetaData title="Products - Inventoryy" />
            ...
            <div className="filterBox">
                ...
                <Slider value={price} onChange = {priceHandler}valueLabelDisplay="auto" aria-labelledby="range-slider" min={0} max={23001} />
